...
This fork is not likely to be maintained in the future and is done purely to port a single project to modern Rails version.
Do not expect it to be completely secure and do not expect further updates.

==Requirements

This version of Casein is jury-rigged for Ruby on Rails 8.x and Ruby 3.4 or later.
...
— Add the Casein gem to your Gemfile:
  ...
  gem 'casein', '~>5.6', github: 'infoman/casein'
